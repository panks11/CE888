...
class Train_Data():
    ...
    def __init__(self, path , filenames):
        ...
        df2 = df2[~df2['query'].str.contains('\);$',case=False)] # filter nested queries
        
        print("Splittin the Train and Test data")
        train, test = train_test_split(df2, test_size=0.2, random_state=50,stratify=df2['db_id'])
...
if __name__ == "__main__":
    sel = Train_Data('D:/DS/Learnin/Essex MS/CE888/git/CE888/assignment2/seq2seq/spider/',['train_spider.json','train_others.json'])
